...
use App\Http\Requests\Chat\CreateGuildRequest;
use App\Http\Resources\Chat\GuildResource;
use App\Services\Chat\GuildService;
...
class GuildController extends Controller
{
    ...
    public function show(int $id)
    {
        return response()->json(
            new GuildResource(
                $this->guildService->getByIdWithChannels($id)
            ),
            Response::HTTP_OK
        );
    }
